...
```bash
# Открыли терминал внутри контейнера
...
```bash
# Проверили статус всех процессов
jps
...
### Шаг 1. Создали директории

```bash
# Создали директории для входных и выходных данных
hdfs dfs -mkdir -p /user/hadoop/input
hdfs dfs -mkdir -p /user/hadoop/output

# Проверили созданные директории
